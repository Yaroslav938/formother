...
#  Основная проверка
# ============================================================
def check_homework(content: dict, api_key: str, subject: str = "Английский язык") -> dict:
    ...
    if content["type"] == "text":
        ...
        if ocr_text:
            text_block += (
                "\n\nПодсказка — предварительно распознанный текст с изображения "
                "(может содержать ошибки распознавания, опирайся в первую очередь на само изображение):\n"
                + ocr_text
            )
        msg_content = [
            {
    ...
    # Собираем текст из всех текстовых блоков ответа (на случай нескольких)
    raw_text = ""
